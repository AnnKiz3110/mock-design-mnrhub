    ...
    <Card className="rounded-xl border shadow-sm overflow-hidden">
      <div className="p-6">
        <div className="mb-4">
          ...
          <p className="text-sm text-gray-500 mt-1">Báo cáo danh sách container thu cược theo kích cỡ</p>
        </div>
              ...
              <tr className="border-b border-gray-200 hover:bg-blue-50/30 transition-colors">
                <td className="px-6 py-5 border-r border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-800">Số lượng container</div>
                    </div>
                  </div>
                </td>
              ...
              <tr className="border-b border-gray-200 hover:bg-orange-50/30 transition-colors">
                <td className="px-6 py-5 border-r border-gray-200">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-medium text-gray-800">Tiền cược</div>
                    </div>
                  </div>
                </td>
                <td className="px-6 py-5 text-center border-r border-gray-200">
