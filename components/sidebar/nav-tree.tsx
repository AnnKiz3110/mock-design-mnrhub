...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Danh sách container thu cược", href: "/reports/deposit" },
      { title: "Báo cáo sản lượng M&R", href: "/reports/output-report" },
      { title: "Báo cáo tồn bãi", href: "/reports/inventory" },
      { title: "Báo cáo Gate Out container", href: "/reports/gateout" },
      ...
      { title: "Quản lý chi phí sửa chữa container theo nhà thầu", href: "/reports/repair-cost" },
      { title: "Quản lý doanh thu", href: "/reports/revenue-management" },
      { title: "Quản lý lợi nhuận", href: "/reports/profit-management" },
